        ...
        <div class="flex items-center justify-between flex-1 mb-4">
          ...
          <div class="">
            ...
            <button wire:click="delete({{ $organization->id }})"
              class="px-3 py-2 mt-2 xl:mt-0 text-xs font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 ">Delete</button>
          </div>
        </div>
