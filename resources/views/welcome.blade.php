...
<body class="font-sans antialiased">
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="" class="flex items-center">
        ...
        {{-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SIMINAW</span> --}}
      </a>
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1
          ...
          Sistem Manajemen Inventaris Aplikasi & Website</h1>
        <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
          Pengelolaan
          Aplikasi & Website di Diskomsantik Kab. Pandeglang</p>
        @auth
        <a href="{{ route('dashboard') }}"
  ...
  {{-- end stat and overview --}}

  {{-- feature section --}}
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Fitur Aplikasi</h2>
        {{-- <p class="text-gray-500 sm:text-xl dark:text-gray-400">keterangan fitur</p> --}}
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div class="bg-primary-50 rounded-lg px-6 py-4 backdrop-blur-xl">
          <div
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">Input Aplikasi & Website</h3>
          <p class="text-gray-500 dark:text-gray-400">Pencatatan Aplikasi & Website yang dikelola Diskomsantik Kab.
            Pandeglang</p>
        </div>
        <div class="bg-primary-50 rounded-lg px-6 py-4 backdrop-blur-xl">
          <div
          ...
          <p class="text-gray-500 dark:text-gray-400">Informasi Aplikasi & Website</p>
        </div>
        <div class="bg-primary-50 rounded-lg px-6 py-4 backdrop-blur-xl">
          <div
            class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">Website Monitoring</h3>
          <p class="text-gray-500 dark:text-gray-400">Monitor website uptime status</p>
        </div>
  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="https://flowbite.com/" class="flex items-center">
            <img src="{{ asset('images/pandeglang.png') }}" class="h-8 mr-3" alt="Siminaw Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Diskomsantik Kab.
              Pandeglang</span>
          </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Tautan Lainnya</h2>
            <ul class="text-gray-600 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <a href="https://pandeglangkab.go.id" class="hover:underline ">Web Pandeglang</a>
              </li>
              <li>
                <a href="https://ppid.pandeglangkab.go.id" class="hover:underline">PPID</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <a href="https://diskomsantik.pandeglangkab.go.id" class="hover:underline">Website</a>
              </li>
              <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://dodiyulian.com/"
            class="hover:underline">Dodi Yulian</a>. All Rights Reserved.
        </span>
